...
public class RandomUtils
{
	 ...
	 * The implementation runs in O(n).
	 * Principally the same as the method shuffleRandomSample() but works on arrays, does not shuffle the source, is not a void method and has a better complexity.
	 * For a discussion and benchmark of various methods of creating random samples see <a href="http://www.java-forum.org/mathematik/116289-random-sample.html"> http://www.java-forum.org/mathematik/116289-random-sample.html</a>
