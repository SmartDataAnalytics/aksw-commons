 ...
 * @param <T>
 */
public class RangeRequestIteratorOld<T>
    extends AbstractIterator<T>
{
    private static final Logger logger = LoggerFactory.getLogger(RangeRequestIteratorOld.class);
    ...
    public RangeRequestIteratorOld(SmartRangeCacheImpl<T> cache, Range<Long> requestRange) {
        super();
        this.cache = cache;
