 ...
 * @param <T>
 */
//public class RangeBufferStandaloneImpl<T>
...
//    }
//
//    protected RangeBufferStandaloneImpl() {
//        super();
//    }
//
//    @SuppressWarnings("unchecked")
//    public RangeBufferStandaloneImpl(int size) {
//        this((T[])new Object[size], TreeRangeSet.create(), TreeRangeMap.create(), -1);
//    }
//
//    public RangeBufferStandaloneImpl(
//            T[] buffer,
//            RangeSet<Long> loadedRanges,
//            RangeMap<Long, List<Throwable>> failedRanges,
//            int knownSize)
//    {
//        super();
//        this.buffer = buffer;
...
//
//    @Override
//    public void putAll(long pageOffset, Object arrayWithItemsOfTypeT, int arrOffset, int arrLength) {
...
//            Range<Long> writeRange = Range.closedOpen(pageOffset, LongMath.saturatedAdd(pageOffset, arrLength))
...
//            return false;
//        RangeBufferStandaloneImpl other = (RangeBufferStandaloneImpl) obj;
