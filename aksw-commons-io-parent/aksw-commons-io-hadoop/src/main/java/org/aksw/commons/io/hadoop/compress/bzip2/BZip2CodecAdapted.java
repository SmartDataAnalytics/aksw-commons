...
/** Adapted version that makes the internal buffer sizes configurable. ~ 2024-09-17 Claus */
...
public class BZip2CodecAdapted implements Configurable, SplittableCompressionCodec {
  ...
  // Buffer size for internal BufferedInputStream
...
//        createInputStreamWithCodecPool(this, conf, in);
  ...
  public CompressionInputStream createInputStream(InputStream in,
    ...
    return Bzip2Factory.isNativeBzip2Loaded(conf) ?
      ...
      new BZip2CompressionInputStream(
              in, 0L, Long.MAX_VALUE, READ_MODE.BYBLOCK, bufferSize);
  }
  ...
  public SplitCompressionInputStream createInputStream(InputStream seekableIn,
    ...
    return new BZip2CompressionInputStream(seekableIn, start, end, readMode, bufferSize);
  }
  ...
  */
  ...
  private static class BZip2CompressionInputStream extends
    ...
    public BZip2CompressionInputStream(InputStream in) throws IOException {
      this(in, 0L, Long.MAX_VALUE, READ_MODE.CONTINUOUS, -1);
    }

    public BZip2CompressionInputStream(InputStream in, long start, long end,
        READ_MODE readMode, int bufferSize) throws IOException {
      super(in, start, end);
      needsReset = false;
      bufferedIn = bufferSize >= 0 ? new BufferedInputStream(super.in, bufferSize) : new BufferedInputStream(super.in);
      ...
      input = new CBZip2InputStreamAdapted(bufferedIn, readMode);
    ...
    */
    ...
    private void internalReset() throws IOException {
      if (needsReset) {
        ...
        input = new CBZip2InputStreamAdapted(bufferedIn, this.readMode);
      }
    }
