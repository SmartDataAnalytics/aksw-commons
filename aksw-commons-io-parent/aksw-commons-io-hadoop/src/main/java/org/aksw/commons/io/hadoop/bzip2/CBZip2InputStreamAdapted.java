 ...
 * </p>
 */
public class CBZip2InputStreamAdapted extends InputStream implements BZip2Constants {
  ...
  */
  private CBZip2InputStreamAdapted.Data data;
  ...
  *             if <tt>in == null</tt>
  */
  public CBZip2InputStreamAdapted(final InputStream in, READ_MODE readMode)
      throws IOException {
    this(in, readMode, false);
  }

  private CBZip2InputStreamAdapted(final InputStream in, READ_MODE readMode, boolean skipDecompression)
      throws IOException {
 ...
 * @throws IOException
  ...
  public static long numberOfBytesTillNextMarker(final InputStream in) throws IOException{
    CBZip2InputStreamAdapted anObject = new CBZip2InputStreamAdapted(in, READ_MODE.BYBLOCK, true);
    return anObject.getProcessedByteCount();
  }

  public CBZip2InputStreamAdapted(final InputStream in) throws IOException {
