	...
	implements Converter
{
	...
	public ConverterImpl(Class<?> from, Class<?> to, Function<Object, Object> fn) {
		super();
		this.from = from;
		this.to = to;
		this.fn = fn;
	...
	public static <I, O> Converter create(
			Class<I> src,
			Class<O> tgt,
			Function<? super I, ? extends O> srcToTgt) {
		return new ConverterImpl(src, tgt, in -> srcToTgt.apply((I)in));
	}
	...
	public static Converter create(Method method, Object obj) {
		...
		return new ConverterImpl(srcType, tgtType, fn);
	}
}
